...
export const msalConfig = {
    auth: {
        ...
        redirectUri: 'https://black-rock-03c110310.3.azurestaticapps.net/redirect', // Points to window.location.origin. You must register this URI on Microsoft Entra admin center/App Registration.
